...
class VaccinationAppoinment:
    ...
    def __new__(cls, input_file):
        if VaccinationAppoinment.__instance is None:
            VaccinationAppoinment.__instance = VaccinationAppoinment.__VaccinationAppoinment(input_file)
        return VaccinationAppoinment.__instance
