...
class VaccineManager:
    ...
    def get_vaccine_date (self, input_file: str)-> str:
        ...
        self.validate_patient_system_id(data["PatientSystemID"])
        self.validate_phone(data["ContactPhoneNumber"])
    ...
    def validate_patient_system_id(self, data: str)-> None:
        patient_system_id_pattern = re.compile(r"[0-9a-fA-F]{32}$")
        result = patient_system_id_pattern.fullmatch(data)
        if not result:
